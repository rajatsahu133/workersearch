          ...
          if($recresult->num_rows>0)
          {
            while($recrow=$recresult->fetch_assoc())
              {?>
                  ...
                  <article class="post-news"><a class="thumbnail-default" href="detail.php?uid=<?php echo $recrow['uid'];?>"  target="_self">
                    <figure><img class="img-responsive" style="height: 220px;" height="270" src="img/user/<?php echo $recrow['image'];?>" alt=""></figure>
                    ...
                    <div style="height: 100px;overflow: hidden; text-align: justify;position: relative;">
                      ...
                      <p><!-- There is an organizational expectation that transportation modes will be sourced and cost will be taken out of the network with some regularity. --><?php echo $recrow['ln'];?></p>
                       <div style=" position: absolute;bottom: 3px; right: 0px; background: white; color: #297fa7; padding-left: 13px;">
                        <a class="post-news-title" href="detail.php?uid=<?php echo $recrow['uid'];?>">Learn More...</a>
                      </div>
