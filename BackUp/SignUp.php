...
$sql="INSERT INTO user(fn,ln,gender,address,skill,email,mobile,image,uid,about)
VALUES('".$_POST['fn']."','".$_POST['ln']."','".$_POST['gender']."',
'".$_POST['address']."','".$_POST['skill']."','".$_POST['email']."',
'".$_POST['mob']."','$image','$uid','".$_POST['about']."')";
...
<body>
  ...
  <form action="SignUp.php" method="post"  id="form1" enctype="multipart/form-data">
    ...
    Confirm Password:<input type="Password" name="password" id="password">
